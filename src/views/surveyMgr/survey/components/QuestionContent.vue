    ...
    >
        <template v-for="(item,index) in pageData.list">
            <div
                    ...
                    :class="{active: selectQuest.key === item.key}"
    ...
    export default {
        ...
        computed: {
            ...mapState({
                ...
                selectQuest: ({app}) => app.selectQuest,
            })
        },
        methods: {
            ...mapMutations({
            ...
            handleSelectWidget(selectQuest) {
                debugger;
                if(this.selectQuest.key !== selectQuest.key){
                    this.setSelectWg({})
                }
                this.$nextTick(()=>{
                    this.setSelectWg(selectQuest)
                })
                this.pageData.list.forEach(item=>{
                    if(item.key === selectQuest.key){
                        item.active = true
                    }else{
                        item.active = false
                    }
